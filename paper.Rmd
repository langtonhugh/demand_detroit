...
That said, a notable shortcoming of these recent contributions is the lack of openly available data and code to reproduce and replicate findings. This is not an uncommon issue in policing research. A recent scoping review of Canadian policing studies concluded that there has been "little effort... to replicate or reproduce findings", with just 8% of the literature sampled constituting replications or reproductions [@huey2017replication, p. 113]. More broadly, in a sample of papers from top criminology journals, @mcneeley2015replication found that just 2% of papers were replications -- either a direct replication of the same population, or empirical generalizations from a different population. The scarcity of replication has been identified as major obstacle to the goals of evidence-based policing, namely, "to develop a rigorous evidence base that can be used by police professionals to develop more efficient and effective police practices, policies, and/or programs" [@openedp2019, p. 126]. In the long-term, open science practices are thought to provide a more concrete base from which police practitioners can make real-life decisions [@openedp2019] and comprise a fundamental component of related fields such as crime science [@laycock2013defining]. It therefore seems appropriate that the investigations of @ratcliffe2021policing and @lum2021can are replicated using open data and methods.

Here, the necessity for a fully open investigation into the scale and composition of police demand is perhaps especially important. This is for two reasons. First, the implications of redefining the role of the police is considerable. It is reasonable for police practitioners and the public to expect a thorough, open and replicable empirical investigation into police demand across numerous contexts before academia concludes that the issue is resolved -- certainly before findings are used to change or introduce police practice or public policy. As noted, committing to radical reform without such investigations might result in shifts in public demand for services for which there is no suitable supply. Second, the data handling required to describe the public demand for the police is not straightforward. Reporting the scale and composition of emergency calls for service data necessitates the grouping of incident types through categorization (e.g., 'mental health', 'community'). As both @ratcliffe2021policing and @lum2021can point out, categorizing incident types is challenging and subject to a degree of interpretation. This issue is exacerbated by the fact that different police jurisdictions will use different incident categories. Thus, an open replication, inclusive of the categorization decisions, facilitates scrutiny through transparency and provides robustness to existing findings.
